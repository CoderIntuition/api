...
REPLACE INTO coderintuition.problem_step (problem_id, step_num, name, type, content, time, created_at, updated_at)
VALUES (@problem1_id, 1, 'Step 1: Understand the Problem', 'TEXT', 'Read the problem and understand it.', 5, '2020-08-29 00:00:00', '2020-08-29 00:00:00');
...
REPLACE INTO coderintuition.test_case(problem_id, test_case_num, name, is_default, input, output, time_limit, memory_limit, stack_limit, created_at, updated_at)
VALUES (@problem1_id, 1, 'Test 1', true, '[1, 2, 3, 4]', '[1, 2, 3, 4]', 10, 10, 10, '2020-08-29 00:00:00', '2020-08-29 00:00:00');

REPLACE INTO coderintuition.test_case(problem_id, test_case_num, name, is_default, input, output, time_limit, memory_limit, stack_limit, created_at, updated_at)
VALUES (@problem1_id, 2, 'Test 1', false, '[3, 1, 4, 2]', '[1, 2, 3, 4]', 10, 10, 10, '2020-08-29 00:00:00', '2020-08-29 00:00:00');

REPLACE INTO coderintuition.solution(problem_id, solution_num, name, is_primary, python_code, description, created_at, updated_at)
...
REPLACE INTO user(name, email, password, language)
...
REPLACE INTO user_role(user_id, role_id) VALUES (@user1_id, @moderator_id);
REPLACE INTO user_role(user_id, role_id) VALUES (@user1_id, @admin_id);
